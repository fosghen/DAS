...
#
# rebuild_proj.tcl: Tcl script for re-creating project 'DAS_from_git'
#
# Generated by Vivado on Mon May 12 12:00:17 +0700 2025
...
#
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/ad2512_lut_config.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/ad9518_lut_config.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/adc_8bit_spi.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/adc_spi.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/ax_debounce.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/power_on_rst.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/spi_8bit_config.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/spi_config.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/spi_master.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/top.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/new/pulse_generator.v"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/ip/adc1_shift/adc1_shift.xci"
#    "D:/DAS_from_git/DAS_from_git.srcs/sources_1/ip/sys_pll/sys_pll.xci"
#    "D:/DAS_from_git/DAS_from_git.srcs/constrs_1/imports/constrains/constr_adc.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/src/ad2512_lut_config.v"]"\
 "[file normalize "$origin_dir/src/ad9518_lut_config.v"]"\
 "[file normalize "$origin_dir/src/adc_8bit_spi.v"]"\
 "[file normalize "$origin_dir/src/adc_spi.v"]"\
 "[file normalize "$origin_dir/src/ax_debounce.v"]"\
 "[file normalize "$origin_dir/src/power_on_rst.v"]"\
 "[file normalize "$origin_dir/src/spi_8bit_config.v"]"\
 "[file normalize "$origin_dir/src/spi_config.v"]"\
 "[file normalize "$origin_dir/src/spi_master.v"]"\
 "[file normalize "$origin_dir/src/top.v"]"\
 "[file normalize "$origin_dir/src/pulse_generator.v"]"\
 "[file normalize "$origin_dir/src/adc1_shift/adc1_shift.xci"]"\
 "[file normalize "$origin_dir/src/sys_pll/sys_pll.xci"]"\
 "[file normalize "$origin_dir/constrains/constr_adc.xdc"]"\
  ...
  set paths [list \
   [file normalize "$origin_dir/ips/ad9238_sample_1.0"] \
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/../../DAS_from_git"]"
...
# Set 'sources_1' fileset file properties for local files
set file "adc1_shift/adc1_shift.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "constrains/constr_adc.xdc"
...
set_property -name "target_constrs_file" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/constrains/constr_adc.xdc" -objects $obj
set_property -name "target_part" -value "xc7z100ffg900-2" -objects $obj
set_property -name "target_ucf" -value "$proj_dir/${_xil_proj_name_}.srcs/constrs_1/imports/constrains/constr_adc.xdc" -objects $obj
...
if { [get_files [list adc1_shift.xci]] == "" } {
  import_files -quiet -fileset sources_1 src/adc1_shift/adc1_shift.xci
}
if { [get_files [list sys_pll.xci]] == "" } {
  import_files -quiet -fileset sources_1 src/sys_pll/sys_pll.xci
}
if { [get_files [list ad2512_lut_config.v]] == "" } {
  import_files -quiet -fileset sources_1 src/ad2512_lut_config.v
}
if { [get_files [list ad9518_lut_config.v]] == "" } {
  import_files -quiet -fileset sources_1 src/ad9518_lut_config.v
}
if { [get_files [list adc_8bit_spi.v]] == "" } {
  import_files -quiet -fileset sources_1 src/adc_8bit_spi.v
}
if { [get_files [list adc_spi.v]] == "" } {
  import_files -quiet -fileset sources_1 src/adc_spi.v
}
if { [get_files [list ax_debounce.v]] == "" } {
  import_files -quiet -fileset sources_1 src/ax_debounce.v
}
if { [get_files [list power_on_rst.v]] == "" } {
  import_files -quiet -fileset sources_1 src/power_on_rst.v
}
if { [get_files [list spi_8bit_config.v]] == "" } {
  import_files -quiet -fileset sources_1 src/spi_8bit_config.v
}
if { [get_files [list spi_config.v]] == "" } {
  import_files -quiet -fileset sources_1 src/spi_config.v
}
if { [get_files [list spi_master.v]] == "" } {
  import_files -quiet -fileset sources_1 src/spi_master.v
}
if { [get_files [list top.v]] == "" } {
  import_files -quiet -fileset sources_1 src/top.v
}
if { [get_files [list pulse_generator.v]] == "" } {
  import_files -quiet -fileset sources_1 src/pulse_generator.v
}
...
# top, pulse_generator
  ...
  # Create ports
  set adc1_clk_n [ create_bd_port -dir I -type clk adc1_clk_n ]
  set adc1_clk_p [ create_bd_port -dir I -type clk adc1_clk_p ]
  set adc1_data_an [ create_bd_port -dir I -from 6 -to 0 adc1_data_an ]
  set adc1_data_ap [ create_bd_port -dir I -from 6 -to 0 adc1_data_ap ]
  set adc1_of_n [ create_bd_port -dir I adc1_of_n ]
  set adc1_of_p [ create_bd_port -dir I adc1_of_p ]
  set adc1_spi_cs [ create_bd_port -dir O adc1_spi_cs ]
  set adc_spi_mosi [ create_bd_port -dir IO adc_spi_mosi ]
  set clk_spi_cs [ create_bd_port -dir O clk_spi_cs ]
  set clk_spi_sclk [ create_bd_port -dir O clk_spi_sclk ]
  set clk_spi_sdio [ create_bd_port -dir IO clk_spi_sdio ]
  ...
  set pulse_o [ create_bd_port -dir O pulse_o ]
  set adc2_spi_cs [ create_bd_port -dir O adc2_spi_cs ]
  set adc2_data_an [ create_bd_port -dir I -from 6 -to 0 adc2_data_an ]
  set adc2_data_ap [ create_bd_port -dir I -from 6 -to 0 adc2_data_ap ]
  set adc1_data_bn [ create_bd_port -dir I -from 6 -to 0 adc1_data_bn ]
  set adc2_clk_n [ create_bd_port -dir I -type clk adc2_clk_n ]
  set adc2_clk_p [ create_bd_port -dir I -type clk adc2_clk_p ]
  set adc1_data_bp [ create_bd_port -dir I -from 6 -to 0 adc1_data_bp ]
  set adc2_of [ create_bd_port -dir I adc2_of ]
  set adc2_data_bp [ create_bd_port -dir I -from 6 -to 0 adc2_data_bp ]
  set adc2_data_bn [ create_bd_port -dir I -from 6 -to 0 adc2_data_bn ]
...
\
  ...
  if { [catch {set pulse_generator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.ADC_PERIOD {5} $pulse_generator_0


  # Create interface connections
  connect_bd_intf_net -intf_net ad9238_sample_0_M00_AXIS [get_bd_intf_pins ad9238_sample_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_net -net ARESETN_1  [get_bd_pins rst_axi_dma/interconnect_aresetn] \
  [get_bd_pins axi_interconnect_dma/ARESETN]
  connect_bd_net -net Net  [get_bd_ports adc_spi_mosi] \
  [get_bd_pins top_0/adc_spi_mosi]
  connect_bd_net -net Net1  [get_bd_ports clk_spi_sdio] \
  [get_bd_pins top_0/clk_spi_sdio]
  connect_bd_net -net ad9238_sample_0_laser_pulse_width_o  [get_bd_pins ad9238_sample_0/laser_pulse_width_o] \
  [get_bd_pins pulse_generator_0/width_signal_i]
  connect_bd_net -net ad9238_sample_0_start_laser_o  [get_bd_pins ad9238_sample_0/start_laser_o] \
  [get_bd_pins pulse_generator_0/signal_start_i]
  connect_bd_net -net adc1_clk_n_0_1  [get_bd_ports adc1_clk_n] \
  [get_bd_pins top_0/adc1_clk_n]
  connect_bd_net -net adc1_clk_p_0_1  [get_bd_ports adc1_clk_p] \
  [get_bd_pins top_0/adc1_clk_p]
  connect_bd_net -net adc1_data_an_0_1  [get_bd_ports adc1_data_an] \
  [get_bd_pins top_0/adc1_data_an]
  connect_bd_net -net adc1_data_ap_0_1  [get_bd_ports adc1_data_ap] \
  [get_bd_pins top_0/adc1_data_ap]
  connect_bd_net -net adc1_data_bn_0_1  [get_bd_ports adc1_data_bn] \
  [get_bd_pins top_0/adc1_data_bn]
  connect_bd_net -net adc1_data_bp_0_1  [get_bd_ports adc1_data_bp] \
  [get_bd_pins top_0/adc1_data_bp]
  connect_bd_net -net adc1_of_n_0_1  [get_bd_ports adc1_of_n] \
  [get_bd_pins top_0/adc1_of_n]
  connect_bd_net -net adc1_of_p_0_1  [get_bd_ports adc1_of_p] \
  [get_bd_pins top_0/adc1_of_p]
  connect_bd_net -net adc2_clk_n_0_1  [get_bd_ports adc2_clk_n] \
  [get_bd_pins top_0/adc2_clk_n]
  connect_bd_net -net adc2_clk_p_0_1  [get_bd_ports adc2_clk_p] \
  [get_bd_pins top_0/adc2_clk_p]
  connect_bd_net -net adc2_data_an_0_1  [get_bd_ports adc2_data_an] \
  [get_bd_pins top_0/adc2_data_an]
  connect_bd_net -net adc2_data_ap_0_1  [get_bd_ports adc2_data_ap] \
  [get_bd_pins top_0/adc2_data_ap]
  connect_bd_net -net adc2_data_bn_0_1  [get_bd_ports adc2_data_bn] \
  [get_bd_pins top_0/adc2_data_bn]
  connect_bd_net -net adc2_data_bp_0_1  [get_bd_ports adc2_data_bp] \
  [get_bd_pins top_0/adc2_data_bp]
  connect_bd_net -net adc2_of_0_1  [get_bd_ports adc2_of] \
  [get_bd_pins top_0/adc2_of]
  connect_bd_net -net axi_dma_0_s2mm_introut  [get_bd_pins axi_dma_0/s2mm_introut] \
  [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net clk_wiz_0_clk_axi_dma  [get_bd_pins clk_wiz_0/clk_axi_dma] \
  [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] \
  [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] \
  [get_bd_pins axi_interconnect_dma/ACLK] \
  [get_bd_pins axi_interconnect_dma/S00_ACLK] \
  [get_bd_pins axi_interconnect_dma/M00_ACLK] \
  [get_bd_pins rst_axi_dma/slowest_sync_clk] \
  [get_bd_pins ad9238_sample_0/m00_axis_aclk]
  connect_bd_net -net clk_wiz_0_clk_axi_lite  [get_bd_pins clk_wiz_0/clk_axi_lite] \
  [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] \
  [get_bd_pins axi_dma_0/s_axi_lite_aclk] \
  [get_bd_pins axi_interconnect_axi_lite/ACLK] \
  [get_bd_pins axi_interconnect_axi_lite/S00_ACLK] \
  [get_bd_pins axi_interconnect_axi_lite/M00_ACLK] \
  [get_bd_pins axi_interconnect_axi_lite/M01_ACLK] \
  [get_bd_pins rst_axi_lite/slowest_sync_clk] \
  [get_bd_pins ad9238_sample_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins processing_system7_0/FCLK_CLK0] \
  [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N  [get_bd_pins processing_system7_0/FCLK_RESET0_N] \
  [get_bd_pins rst_adc/ext_reset_in] \
  [get_bd_pins rst_axi_dma/ext_reset_in] \
  [get_bd_pins rst_axi_lite/ext_reset_in]
  connect_bd_net -net pulse_generator_0_pulse_o  [get_bd_pins pulse_generator_0/pulse_o] \
  [get_bd_ports pulse_o]
  connect_bd_net -net rst_adc_peripheral_aresetn  [get_bd_pins rst_adc/peripheral_aresetn] \
  [get_bd_pins ad9238_sample_0/adc_rst_n] \
  [get_bd_pins pulse_generator_0/reset_i]
  connect_bd_net -net rst_axi_dma_peripheral_aresetn  [get_bd_pins rst_axi_dma/peripheral_aresetn] \
  [get_bd_pins axi_interconnect_dma/S00_ARESETN] \
  [get_bd_pins axi_interconnect_dma/M00_ARESETN] \
  [get_bd_pins ad9238_sample_0/m00_axis_aresetn]
  connect_bd_net -net rst_axi_lite_interconnect_aresetn  [get_bd_pins rst_axi_lite/interconnect_aresetn] \
  [get_bd_pins axi_interconnect_axi_lite/ARESETN]
  connect_bd_net -net rst_axi_lite_peripheral_aresetn  [get_bd_pins rst_axi_lite/peripheral_aresetn] \
  [get_bd_pins axi_dma_0/axi_resetn] \
  [get_bd_pins axi_interconnect_axi_lite/S00_ARESETN] \
  [get_bd_pins axi_interconnect_axi_lite/M00_ARESETN] \
  [get_bd_pins axi_interconnect_axi_lite/M01_ARESETN] \
  [get_bd_pins ad9238_sample_0/s00_axi_aresetn]
  connect_bd_net -net rst_n_0_1  [get_bd_ports rst_n] \
  [get_bd_pins top_0/rst_n]
  connect_bd_net -net sys_clk_n_0_1  [get_bd_ports sys_clk_n] \
  [get_bd_pins top_0/sys_clk_n]
  connect_bd_net -net sys_clk_p_0_1  [get_bd_ports sys_clk_p] \
  [get_bd_pins top_0/sys_clk_p]
  connect_bd_net -net top_0_adc1_clk  [get_bd_pins top_0/adc1_clk] \
  [get_bd_pins rst_adc/slowest_sync_clk] \
  [get_bd_pins ad9238_sample_0/adc_clk] \
  [get_bd_pins pulse_generator_0/clk_adc_i]
  connect_bd_net -net top_0_adc1_data_14_a  [get_bd_pins top_0/adc1_data_14_a] \
  [get_bd_pins ad9238_sample_0/adc_data]
  connect_bd_net -net top_0_adc1_spi_cs  [get_bd_pins top_0/adc1_spi_cs] \
  [get_bd_ports adc1_spi_cs]
  connect_bd_net -net top_0_adc2_spi_cs  [get_bd_pins top_0/adc2_spi_cs] \
  [get_bd_ports adc2_spi_cs]
  connect_bd_net -net top_0_clk_spi_cs  [get_bd_pins top_0/clk_spi_cs] \
  [get_bd_ports clk_spi_cs]
  connect_bd_net -net top_0_clk_spi_sclk  [get_bd_pins top_0/clk_spi_sclk] \
  [get_bd_ports clk_spi_sclk]
  connect_bd_net -net trig_in_0_1  [get_bd_ports trig_in] \
  [get_bd_pins top_0/trig_in]
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../DAS_from_git/DAS_from_git.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
